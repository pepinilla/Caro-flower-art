// Bouquets.js - Load bouquets with filters
...
function getCategoryName(category) {
    const names = {
        ...
        'mini': 'Mini Bouquets / Ramos Mini',
        'ocasion': 'Any Occasion / Cualquier Ocasión'
    };
    return names[category] || category;
}

// Load and render bouquets
async function renderBouquets() {
    const grid = document.getElementById('bouquetsGrid');
    if (!grid) return;
    
    try {
        grid.innerHTML = '<div class="loading">Loading bouquets... / Cargando ramos...</div>';
        ...
        grid.innerHTML = bouquets.map(product => `
        ...
        grid.innerHTML = '<div class="error-message">Error loading bouquets / Error al cargar ramos</div>';
    }
}
